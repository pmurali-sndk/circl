...
[![GitHub release](https://img.shields.io/github/release/cloudflare/circl.svg)](https://github.com/pmurali-sndk/circl/releases/)
[![CIRCL](https://github.com/pmurali-sndk/circl/workflows/CIRCL/badge.svg)](https://github.com/pmurali-sndk/circl/actions)
[![GoDoc](https://godoc.org/github.com/pmurali-sndk/circl?status.svg)](https://pkg.go.dev/github.com/pmurali-sndk/circl?tab=overview)
[![Go Report Card](https://goreportcard.com/badge/github.com/pmurali-sndk/circl)](https://goreportcard.com/report/github.com/pmurali-sndk/circl)
...
🚨 This library is offered as-is, and without a guarantee. Therefore, it is expected that changes in the code, repository, and API occur in the future. We recommend to take caution before using this library in a production application since part of its content is experimental. All security issues must be reported, please notify us immediately following the instructions given in our [Security Policy](https://github.com/pmurali-sndk/circl/security/policy).
...
```sh
go get -u github.com/pmurali-sndk/circl
```

Alternatively, look at the [Cloudflare Go](https://github.com/pmurali-sndk/go/tree/cf) fork to see how to integrate CIRCL natively in Go.
...
https://github.com/pmurali-sndk/circl. v1.6.1 Accessed Apr, 2025.
```
