...
import (
	...
	"github.com/pmurali-sndk/circl/pke/kyber/internal/common/params"
)
...
func invNttAVX2() {
	...
	//
	//  https://github.com/pmurali-sndk/circl/wiki/images/kyber-invntt-avx2.svg
	//
...
func nttAVX2() {
	...
	//
	//  https://github.com/pmurali-sndk/circl/wiki/images/kyber-ntt-avx2.svg
	//
	// The vertical lines with circles on the end represent butterflies.
	// The number in those butterflies refers to the index into the Zetas
	// array of which ζ is used.  (Note that this array is different from
